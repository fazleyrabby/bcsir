<?php
include_once 'phpword_header.php';
...
$textrun = $section->addTextRun();
$textrun->addText('◎', array('size' => 10, 'bold' => true));
$textrun->addText(' Pre-Screener\'s Portion)', $applicantPortion);
...
$textrun = $section->addTextRun();
$textrun->addText('◎', array('size' => 10, 'bold' => true));
$textrun->addText(' Interviewer\'s Portion', $applicantPortion);
...
$paragraphStyle = array('size' => 10, 'spaceAfter'=>0, 'spaceBefore'=>0, 'bold' => true);
$textrun = $section->addTextRun();
$textrun->addText('◎', array('size' => 10, 'spaceAfter'=>0, 'spaceBefore'=>0, 'bold' => true));
$textrun->addText(' Affidavit of Interviewee', $applicantPortion, $paragraphStyle);
