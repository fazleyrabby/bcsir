...
class publisher extends Database{
    ...
    public function store(){
        ...
        $sqlQuery = "INSERT INTO publisher (name) VALUES (?);";
    ...
    public function index(){
        $sqlQuery = "SELECT * FROM publisher ORDER BY id";
    ...
    public function view(){
        $sqlQuery = "SELECT * FROM publisher WHERE id = $this->id";
    ...
    public function update(){
        ...
        if ($name=='') {
            ...
            $sqlQuery = "UPDATE publisher SET name = ? WHERE id = $this->id;";
            $dataArray = array($name) ;
