                   ...
                   <form class="form-horizontal form-groups-bordered validate" id="user_form"  target="_top" method="post" accept-charset="utf-8">
                           <?php echo $token;?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">লেখকের নাম</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="name" name="name" data-validate="required" data-message-required="Value Required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">লেখকের কোড</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="author_code" name="code" data-validate="required" data-message-required="Value Required"/>
                                </div>
                            </div>
                            <div class="form-group">
