...
$singleData = $objBook->viewBookSubCategory();
$pageHeading ='Book Sub Category';
?>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel-body">
                <form action="update.php" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="subCatcode" value="<?php echo $singleData->code?>" data-validate="required" data-message-required="Value Required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" name="updateBookSubCategory" class="btn btn-info">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
