...
$pageHeading ='উপ বিভাগ';

?>
    <h3 style=""><i class="entypo-right-circled"></i> বইয়ের  <?php echo $pageHeading?></h3>
    <hr />
    <div class="row">
        <div class="col-md-12">
            <!------CONTROL TABS START------>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function(){
        ...
        var dataTable = $('#user_data').DataTable({
            ...
            "order":[],
            "ajax":{
                url:"fetch.php?postId=allData&page=s_cat",
                type:"POST"
            },
            "columnDefs":[
                {
        ...
        $(document).on('submit', '#user_form', function(event){
            event.preventDefault();
                ...
                $.ajax({
                    url:"fetch.php?postId=insert&page=s_cat",
                    method:'POST',
        ...
        $(document).on('click', '.update', function(){
            ...
            $.ajax({
                url:"fetch.php?postId=update&page=s_cat",
                method:"POST",
        ...
        $(document).on('click', '.delete', function(){
         ...
         //   jQuery('#modal-4').modal('show', {backdrop: 'static'});
           if(confirm("Are you sure you want to delete this?"))
            { 
                $.ajax({
                    url:"fetch.php?postId=delete&page=s_cat",
                    method:"POST",
                    data:{user_id:user_id},
                    success:function(data)
                    {
