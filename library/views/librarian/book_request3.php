                            ...
                            <div class="col-sm-12">
                               <table class="table table-bordered" id="dynamic_field">
                                    ...
                                    <tr id="row_0">
                                        ...
                                        <td><input type="number" class="form-control" name="buyPrice"  readonly="readonly" value="500"></td>
                                        <td><input type="number" class="form-control" name="unitPrice"   min="0" oninput="calculate('row_0')" onkeypress='validate(event)'></td>
                                        <td><input type="number" class="form-control qty" name="qty" min="0" value="1" oninput="calculate('row_0')" onkeypress='validate(event)'></td>
                                        <!--<td> <input type="text" required="required" name="qty" oninput="calculate('row_0')"></td>-->
                                        <td> <input type="number" class="form-control" name="paidAmount" readonly="readonly" id="paidAmount0" min="0" value="0"></td>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function(){
        ...
        $('#add2').click(function(){
            ...
            $('#dynamic_field').append('<tr id="row_'+i+'"><td>'+i+'</td>' +
                '<td><select name="bookId[]" id="bookId'+i+'" class="form-control" required><?php foreach ($allBookData as $record){ echo "<option value=\"$record->id\">$record->name($record->desk_name Row-$record->desk_row)</option>";} ?></select></td>' +
                '<td> <select name="payType" id="payType'+i+'" class="form-control" required> <option value="0">পড়ার জন্য </option><option value="1">উপহারের জন্য</option><option value="2">বিক্রয়ের জন্য</option></select></td>' +
                '<td><input type="number" class="form-control" name="buyPrice"  readonly="readonly"  id="buyPrice'+i+'" value="500"></td>' +
                '<td><input type="number" class="form-control unitPrice2" name="unitPrice" id="unitPrice'+i+'" value="0" oninput="calculate(\'row_'+i+'\')" onkeypress=\'validate(event)\'></td>' +
                '<td><input type="number" class="form-control qty" name="qty" id="'+i+'" value="1" oninput="calculate(\'row_'+i+'\')"  onkeypress=\'validate(event)\'></td>' +
                '<td> <input type="number" class="form-control" name="paidAmount" readonly="readonly" id="paidAmount'+i+'" value="0"></td>' +
 ...
 <script type="text/javascript">
   ...
   var mainRow = document.getElementById(elementID);
    ...
    var myBox2 = mainRow.querySelectorAll('[name=unitPrice]')[0].value;
    var total = mainRow.querySelectorAll('[name=paidAmount]')[0];
