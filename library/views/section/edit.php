...
$objSection = new \App\section\section();
$objSection->setData($_GET);
$singleData = $objSection->view();
$pageHeading ='Section';
?>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <form action="update.php" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                               <input type="text" class="form-control" name="secName" data-validate="required" data-message-required="Value Required" value="<?php echo $singleData->sec_name?>" autofocus="">
                        </div>
                    </div>
