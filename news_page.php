...
<section class="flat-row1 full-color parallax4">
    ...
    {
    $page_id=$_GET['news_page_id'];	
     if ($page_id != "all_news") {
        $r="SELECT id,news_title,news_st,news_des,image,add_by,created_at from news where id='$page_id' and news_st = 1";
    ...
    while($d=mysqli_fetch_array($rp))
        ...
        <div class="post-item blog-post-item">
            ...
            <div class="content-pad charmen_div col-md-12" style="color: #19791a;">
                   <?php 
                   if($image != ''){?>
                   <img src="<?php echo "admin/admin/Action/uploads/$image";?>" alt="image" class="Img_chairmen" >
                  <?php }
                   ?>
      ...
      $r="SELECT id,news_title,news_st,news_des,image,add_by,created_at from news WHERE news_st = 1 ";
      $rp=mysqli_query($conn,$r);
      if($rp==true)
      {
