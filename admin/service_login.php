...
<div class="container" style="margin-top:30px;">
    <div class="row">
        ...
        <a href="<?=$baseurl?>" class="btn btn-danger">প্রথম পাতা</a>
           ...
           if ($_GET['usr'] == 'app') 
           {
              $login_type = '(বিশ্লেষণ সেবা সংক্রান্ত)';
           }
           elseif($_GET['usr'] == 'cpto')
           {
              $login_type = '(ক্রয় সেবা সংক্রান্ত)';
           }
            elseif($_GET['usr'] == 'accounts')
           {
              $login_type = '(হিসাব শাখা)';
           }
            elseif($_GET['usr'] == 'other_payment_usr')
           {
              $login_type = '(অন্যান্য পেমেন্ট)';
           }
           ?>
            <p class="text-center" style="font-size: 20px"><strong>লগইন করুন&nbsp;&nbsp;<?=$login_type?></strong></p>
            <hr>
           ...
           if ($_GET['usr'] == 'app') 
           { 
              echo "<img src='".$baseurl."images/test_app.jpg' alt='' width='50%'>";
           }
           elseif($_GET['usr'] == 'cpto')
           {
              echo "<img src='".$baseurl."images/purchase.png' alt='' width='70%'>";
           }
           elseif($_GET['usr'] == 'accounts')
           {
              echo "<img src='".$baseurl."images/purchase.png' alt='' width='70%'>";
           ...
           ?>
            ...
            <div class="col-md-6 col-sm-6" style="border-left:1px grey dotted;">
                ...
                <?php if(isset($_GET['usr'])){
                            $service_type = $_GET['usr']; ?>
                        
                        <input type="hidden" value="<?php echo $service_type?>" name="service_type">
                           <?php 
                           
                        if($service_type == 'accounts') { ?>
                            <h2 class="text-center" style = "padding-bottom:20px;font-size:15px;font-weight:700;color:red">শুধুমাত্র হিসাব শাখার ব্যবহারের  জন্য প্রযোজ্য</h2>
                       <?php }
