  ...
  <?php 
        ...
        <div class="issue_info ">
							...
							<tr>
                                <td valign="top" width="50%">
                                    <p align="center">প্রতিবেদনের ধরণ :&nbsp;
                                        সকল কর্মচারীদের বেতন ভাতার তালিকা <?php if ($years != '' || $month != '') {
            ...
            <tr>
                ...
                <?php 
                    if ($years == '' || $month == '') {
                    $salary_data = mysqli_query($conn,"SELECT employee_id,amount from salary_details_employee");
                    }
                    else 
                    { 
                    $salary_data = mysqli_query($conn,"SELECT employee_id,amount from salary_details_employee where year like '$years' and month like '$month'");
                    }
                    $serial=0;
                    $total=0;
                    $salary_bd = 0;
                    $salary_data_row = mysqli_num_rows($salary_data);
                    if ($salary_data_row > 0) {
                        while ($data = mysqli_fetch_array($salary_data)) {
                            ...
                            $salary_bd = str_replace($en_num, $bn_num , $total);
                            }
                            ...
                            $employee_id_q_row = mysqli_num_rows($employee_id_q);
                            if ($employee_id_q_row > 0) {
                            ...
                            $type = '';
                            if ($employee_type == 1 or $employee_type == 4) {
                                $type = "কর্মকর্তা ";
                            }
                       
                            elseif ($employee_type == 2 or $employee_type == 3) {
                                $type = "বিজ্ঞানী";
                            }
                            echo "<td>$type</td>";
                            ...
                            {
                            $total_salary_bd = str_replace($en_num, $bn_num , $salary_total);
                            }
                            echo "<td>$total_salary_bd</td>";
                            echo "</tr>";
                            }
                            }
                            ...
                            echo 'setTimeout(function () { swal({
                                ...
                                location.href = "salary.php?salary=salary_list_all"
                            })';
                            echo '}, 10);</script>';
                     }
                    ...
                    <tfoot>
                        <tr>
                        <td colspan="5" style="text-align:right"><span style="color:red;text-decoration:underline;font-weight:700"></span>সর্বমোট খরচ </td>
                        <td colspan="1"><?=$salary_bd?></td>
                        </tr>
                    </tfoot>       
                </table>
            </th></tr>
