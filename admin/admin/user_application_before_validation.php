            ...
            <div class="control-group">
                ...
                <div class="control-group">
                                ...
                                <div class="controls p_relative">
                                    <select data-placeholder="নির্বাচন করুন" class="chzn-select span6 method_list" multiple="multiple" id='method_price_id' name="method_selct_id[]" tabindex="6"  onchange="get_method_price();">
                                        <option value=""></option>
                                    </select>
                                     <span class="custom_pointer">
                                        <i class="icon-plus-sign custom_icon_plus"></i>
