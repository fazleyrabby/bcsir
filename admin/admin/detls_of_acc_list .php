	...
	<div class="widget red">
     ...
     <div class="span12">
		...
		<?php
            ...
            { ?>
             <form action="Action/form_details_submit.php" method="POST" class="form-horizontal" enctype=multipart/form-data>
             ...
             <input type="hidden" value="<?=$_SESSION['user_id']?>" name="user_id">
                <div class="control-group">
                    ...
                    <label class="control-label">মন্তব্য:</label>
                        <div class="controls">
                      <textarea name="comments_id" id="" cols="60" rows="5">
				...
				<div class="control-group">
					<div class="controls">
                        <td><input class='btn btn-success btn_success_custom' type="submit" name="approve_md" value="Approve">
                        &nbsp;&nbsp;
                        </td> 
                        <td><input class='btn btn-danger' type="submit" name="approve_md" value="Reject">
                        &nbsp;&nbsp;
					</div>
				</div>
