...
<body>
  ...
  <?php 
                if (isset($_POST['salary_head_all'])) { 
                    $datepicker_salary_head = $_POST['datepicker_salary_head'];
                        ...
                        <table style="border-top:2px #000000 solid;" cellpadding="0" cellspacing="0" height="20" width="860">
							...
							<tr>
                                ...
                                ?>
                                    ...
                                    <span><?php echo "খাতে প্রদানকৃত অর্থের তালিকা($salary_head)"?></span>

                                    <?php echo "<h3 align='center'>$bd_month,$bd_year</h3>";?></p>
                                </td>
                            </tr>
