             ...
             if($level==2){?>
               ...
               echo"<span><h3> এমডি রিজেক্টেড-তালিকা</h3></span>";
                    if($md_rejc_list==true)
                    {
                        ...
                        <td>$recv_con_type</td>
                         <td>$confirm_id</td>
                        <td><a href='Action/add_requirement.php?approve_form=approve_requermnt&user_requr_id=$reqrmnt_tbl_id&status=7'><span class='btn btn-success'>Send</span></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        
                        <td><a href='Action/add_requirement.php?approve_form=approve_requermnt&user_requr_id=$reqrmnt_tbl_id&status='><span class='btn btn-success'>Cancel</span></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        </td>";
                        echo "</tr>";
                        }
