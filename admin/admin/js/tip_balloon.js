...
Initial author: Lokendra Parashar
...
config.BalloonImgPath = "../ToolTip/tip_balloon/BaloonImages/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
