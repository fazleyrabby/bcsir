            ...
            <div id="bottom-nav">
                <div class="container">
                    ...
                    <div class="row footer-content">
                        ...
                        <nav class="col-md-6 footer-social text-right">
                            <ul class="social-list">
                                <li>
                                    <span style="font-size: 18px;">পরিদর্শক সংখ্যা - </span>
                                    <a href="#"><img src="http://www.cutercounter.com/hits.php?id=geopfcp&nd=7&style=80" border="0" alt="website counter"></a>
                                </li>
                                <!--<li>-->
