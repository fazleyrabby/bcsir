...
<head>
    <title> সকল বিজ্ঞানীদের নামের তালিকা </title>
							...
							<tr>
                                <td valign="top" width="50%">
                                    <p align="center">প্রতিবেদনের ধরণ :&nbsp;
                                        সকল বিজ্ঞানীদের নামের তালিকা </p>
                                </td>
                            </tr>
                ...
                <tr>
                    <th colspan="3" scope="row" align="center" height="50" valign="top">
                        <table class="tbl-list" width="600">
                            ...
                            <?php 
                            $all_scientists_list= mysqli_query($conn,"SELECT employee_name,designation,employee_id from employee_details where employee_type = 2 AND employee_st = 1 order by employee_serial");
                            $serial = 0;
                            if($all_scientists_list == true){
                                while($data = mysqli_fetch_array($all_scientists_list)){
                                    ...
                                    $id = $data["2"];
                                   {
                                    ...
                                    echo "<td style='width:55%;text-align:left'>$name</td>
