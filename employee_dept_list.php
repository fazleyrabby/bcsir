                ...
                <div class="blog-item col-md-9 col-sm-12" style="background-color: #fff">
                    <div class="post-item blog-post-item">
                        <div class="row">
                          ...
                          <table id="employee" class="table-bordered table-striped" style="width:100%">
                            <thead>
                            <tr>
                                <th>ইমেইজ</th>
                                <th>পদবী</th>
                            ...
                            {
                                $dept_id = $_GET['dept'];
                                $all_scientists_list= mysqli_query($conn,"SELECT employee_name,designation,employee_id,images,join_date,employee_department from employee_details where employee_st = 1 and employee_department =$dept_id");
                            }
                            else 
                            {
                                $all_scientists_list= mysqli_query($conn,"SELECT employee_name,designation,employee_id,images,join_date,employee_department from employee_details where employee_st = 1 order by id");
                            }
                            ...
                            if($all_scientists_list == true){
                                while($data = mysqli_fetch_array($all_scientists_list)){
                                    ...
                                    echo "</td>";
                                    echo "<td style='width:25%;text-align:left'>$name
                                    </td>";
