...
<div class="page-title parallax parallax4">
    ...
    <section class="flat-row1 full-color parallax4">
        <div class="container">
            <div class="row">
            <h3 style="font-size:20px;padding:1em;text-align:center"><span>বিজ্ঞানীদের তালিকা </span></h3>
                ...
                <div class="blog-item col-md-9 col-sm-12" style="background-color: #fff">
                    <div class="post-item blog-post-item">
                        <div class="row">
                          ...
                          <table id="scientist" class="table-bordered table-striped" style="width:100%;table-layout:fixed">
                            <thead>
                            <tr>
                                <th>ইমেইজ</th>
                            ...
                            <tbody>
                            <?php 
                            $all_scientists_list= mysqli_query($conn,"SELECT employee_name,designation,employee_id,images,join_date,employee_department,cv_file from employee_details where employee_type in (2,3) AND employee_st = 1 order by id");
                            $serial = 0;
                            if($all_scientists_list == true){
                                while($data = mysqli_fetch_array($all_scientists_list)){
                                    ...
                                    if($cv == ''){
                                      $cv_file = "<span style='font-weight:700;border:0;border-radius:0' class='btn btn-danger' disabled>ফাইল নেই</span>";
                                    }
                                    else {
                                       $cv_file = "<a target=_blank style='font-weight:700;border:0;border-radius:0' class='btn btn-primary' href ='admin/admin/Action/uploads/$cv'>ফাইল লিংক</a>";
                                    }
                                    {
                                    ...
                                    echo "</td>";
                                    echo "<td style='width:25%;text-align:left'><a href='employee_details.php?id=$id'><span style='position: absolute;
                                    visibility: hidden;'>নাম:</span>$name</a>
                                    </td>";
